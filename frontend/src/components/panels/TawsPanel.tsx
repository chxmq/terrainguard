      ...
      {tawsResult && (
        <section>
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-4">
            ...
            <DataField label="Look-Ahead Horizon"  value={`${fmt(tawsResult.envelope.horizon_nm, 1)} NM`} />
            <DataField label="Look-Ahead Time (caution_lookahead_s)" value={`${fmt(tawsResult.envelope.caution_lookahead_s, 1)} s`} />
            <DataField label="Time Gain (ttci_time_gain_applied)" value={`+${tawsResult.envelope.ttci_time_gain_applied}`} accent />
            <DataField label="Clearance Floor Boost" value={`+${fmt(tawsResult.envelope.ttci_clearance_gain_applied * 100, 0)}%`} accent />
          </div>
          <div className="mt-4">
